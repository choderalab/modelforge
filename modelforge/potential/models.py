...
from typing import TYPE_CHECKING, Any, Dict, Mapping, NamedTuple, Tuple, Type
...
if TYPE_CHECKING:
    ...
    from modelforge.potential.convert import JAXModel
...
class NeuralNetworkPotentialFactory:
    ...
    def create_nnp(
        ...
        if use == "training":
            ...
            if simulation_environment == "JAX":
                from modelforge.potential.convert import PyTorch2JAXConverter
