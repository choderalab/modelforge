...
def main():
    ...
    output_file_dir = f"{local_prefix}/hdf5_files/ani1x_dataset"
    ...
    ani1x_dataset = ANI1xCuration(
        dataset_name="ani1x",
        local_cache_dir=local_cache_dir,
        version_select=version_select,
    )

    ani1x_dataset.process(force_download=False)
    ...
    n_total_records, n_total_configs = ani1x_dataset.to_hdf5(
    ...
    about = f"""This provides a curated hdf5 file for a subset of the ANI-1x dataset designed 
    ...
    about = f"""This provides a curated hdf5 file for the ANI-1x dataset designed
    to be compatible with modelforge. This dataset contains {n_total_records} unique records 
